...
let miAnimalFavorite = "perro";
console.log("Mi animal favorito es un perro: ", miAnimalFavorite == "perro");

console.log("flan vs flan con dulce de leche: ", "flan" != "flan con dulce de leche");

let miEdad = 46;
let soyMayorDeEdad = miEdad > 17;
console.log("Soy mayor de edad: ", soyMayorDeEdad);

let soyMenorDe25 = miEdad < 25;
console.log("Soy menor de 25: ", soyMenorDe25);

let mesActual = "marzo";
let estamosEnEnero = mesActual === "enero";
console.log("Estamos en enero: ", estamosEnEnero);
...
let horaActual = 10;
let esHoraDeDesayunar = horaActual <= 12;
console.log("Es hora de desayunar: ", esHoraDeDesayunar);
